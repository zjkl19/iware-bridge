<template>
  <div class="photo">
    ...
    >
      <img :src="lookUrl" alt="" style="width: 100%" />
    </el-dialog>
    <!-- 添加图片弹框 -->
    <el-dialog
      class="photoDialog"
    ...
    >
      <div class="photo-Dev">
        ...
        <div class="photo-up flex flex-start">
          <p style="padding: 0 1vw 0 0">图片上传:</p>
          <!-- 图片上传显示 -->
          <el-upload
            :action="actionUrl"
        ...
        <div class="photo-remarks flex flex-start">
          <p style="width: 3.5vw; text-align: right; height: 15vh">备注:</p>
          <div style="width: 100%; padding: 0 0 0 0.9vw">
            <el-input
              type="textarea"
              placeholder="请输入内容"
...
export default {
  ...
  methods: {
    ...
    uploadFileList() {
      ...
      uploadFiles(this.fileData, 2).then((res) => {
        loading.close();
        this.cannelUpload();
        this.$message({
          message: '上传成功',
