...
import com.iware.common.exception.ArgumentException;
...
public class AssertUtils {
     ...
     */
    public static void isNull(Object object, EnumInterface errorCode) {
        if (object != null) {
     ...
     */
    public static void noNullElements(Object[] array, EnumInterface errorCode) {
        if (array != null) {
