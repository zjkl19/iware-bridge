...
@ApiModel(value="DiseaseInstanceRecord", description="桥梁检测病害实例记录表")
public class DiseaseInstanceRecord implements Serializable {
    ...
    @ApiModelProperty(value = "桥梁检测病害实例id")
